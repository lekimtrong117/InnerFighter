...
public class GreenFatDragon : FatDragon
{
    public override void OnShoot()
    {
        ...
        {
            Projectile projectile = PrefabManager.Instance.CreateProjectile("LeafStorm", player_pos, damageData, Target_tag.Player, false, false);
