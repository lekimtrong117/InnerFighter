...
public class GrassDashSKillControl : DashSkill
{
    private void Awake()
    {
        SkillSetUp();
    ...
    public override void SkillSetUp()
    {
        ...
        skill_Base_HPdamage_scale = 3;
        skill_Base_SPdamage = 15;
    ...
    {  // with fire dash skill,target point is a point that is infront of yena, not nearest enemy
        ...
        rockspike.SetUp(cast_point, damageData, Target_tag.Enemy, true, false);
        rockspike.FlyTo(dash_point, skill_Base_flyspeed, skill_Base_max_flydistance);
    }
}
