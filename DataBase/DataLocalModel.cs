...
public class DataLocalModel : MonoBehaviour
{
    ...
    public void CreateData(Action callback)
    {
        ...
        else
        {
            ...
            playerStat.level = 1;
            playerStat.focus = 0;
            playerStat.creative = 0;
            playerStat.lucid = 0;
            playerStat.endurance = 0;
            playerStat.elemental = Elemental.Water;
            userdata.playerstat = playerStat;
            DifficultModidier difficultModidier = new DifficultModidier();
            difficultModidier.pricepoint = 0;
            difficultModidier.enemyattackpoint = 0;
            difficultModidier.enemyhealthpoint = 0;
            difficultModidier.yinglimitpoint = 0;
            userdata.difficultmodifier = difficultModidier;
            userdata.essence = 0;
            userdata.highestscore = 0;
            userdata.dicpurchase = new Dictionary<string, bool>();
            userdata.dicpurchase.Add("SeconChance", false);
            userdata.dicpurchase.Add("LastChance", false);
            userdata.dicpurchase.Add("AnOptimist", false);
            userdata.dicpurchase.Add("Burden", false);
            userdata.dicpurchase.Add("AnythinnElse", false);
            userdata.dicpurchase.Add("InnerRunner", false);
            userdata.dicpurchase.Add("UltraUltimate", false);
            SaveData();
            callback();
        }
    }
