...
public class WaterBallSkillControl : SpellSkill
{
    private void Awake()
    {
        SkillSetUp();
    ...
    public override void SkillSetUp()
    {
        ...
        skill_Base_HPdamage_scale = 0.67f*Projectile.stay_damgae_rate;
        skill_Base_SPdamage = 6.67f*Projectile.stay_damgae_rate;
        skill_Base_flyspeed = 1.5f;
        skill_Base_max_flydistance =9;
    }
    public override void OnSkillCast(Vector3 cast_point, Vector3 target_point)
    {
        ...
        //
        WaterBall waterball = PoolManager.Instance.Spawn("WaterBall").gameObject.GetComponent<WaterBall>();
        ...
        waterball.SetUp(cast_point, damageData, Target_tag.Enemy, true, false);
        waterball.FlyToAnDealStayDamge(target_point, skill_Base_flyspeed, skill_Base_max_flydistance);
    }
